...
class Conditions extends Generic
{
    ...
    public function toHtml()
    {
        ...
        $renderer = $this->fieldset->setTemplate('Magento_CatalogRule::promo/fieldset.phtml')
            ...
            ->setNameInLayout('amasty.groupassign.rule.fieldset.conditions');
        ...
        $form
            ->setValues($this->rule->getData())
            ->setNameInLayout('amasty.groupassign.rule.tab.conditions');
        $this->setConditionFormName($this->rule->getConditions(), Rule::FORM_NAMESPACE, $conditionsFieldSetId);
     ...
     * @param string $conditionsFieldSetId
     * @return void
     */
    private function setConditionFormName(AbstractCondition $abstractConditions, $formName, $conditionsFieldSetId)
    {
